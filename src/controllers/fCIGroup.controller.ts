...
import { FCIGroupService } from '../services/fCIGroup.service';
import { memoryCache } from '../utils/cache';

const service = new FCIGroupService();
...
export const create = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    memoryCache.clear();
    await AuditLogger.log(req, 'CREATE', 'FCIGROUP', data.id, null, data);
...
export const update = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    memoryCache.clear();
    await AuditLogger.log(req, 'UPDATE', 'FCIGROUP', data.id, null, data);
...
export const remove = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    memoryCache.clear();
    await AuditLogger.log(req, 'DELETE', 'FCIGROUP', req.params.id as string, null, null);
...
export const bulkRemove = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    memoryCache.clear();
    await AuditLogger.log(req, 'BULK_DELETE', 'FCIGROUP', null, null, { ids: req.body.ids });
