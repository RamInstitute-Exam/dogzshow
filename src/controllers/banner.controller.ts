...
export const create = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    await AuditLogger.log(req, 'CREATE', 'BANNER', data.id, null, data);
...
export const update = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    await AuditLogger.log(req, 'UPDATE', 'BANNER', data.id, null, data);
...
export const remove = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    await AuditLogger.log(req, 'DELETE', 'BANNER', req.params.id as string, null, null);
...
export const bulkRemove = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    await AuditLogger.log(req, 'BULK_DELETE', 'BANNER', null, null, { ids: req.body.ids });
