...
export const create = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    await AuditLogger.log(req, 'CREATE', 'NOTIFICATION', data.id, null, data);
...
export const update = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    await AuditLogger.log(req, 'UPDATE', 'NOTIFICATION', data.id, null, data);
...
export const remove = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    await AuditLogger.log(req, 'DELETE', 'NOTIFICATION', req.params.id as string, null, null);
...
export const bulkRemove = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    await AuditLogger.log(req, 'BULK_DELETE', 'NOTIFICATION', null, null, { ids: req.body.ids });
