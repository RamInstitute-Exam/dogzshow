...
export const create = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    await AuditLogger.log(req, 'CREATE', 'TESTIMONIAL', data.id, null, data);
...
export const update = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    await AuditLogger.log(req, 'UPDATE', 'TESTIMONIAL', data.id, null, data);
...
export const remove = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    await AuditLogger.log(req, 'DELETE', 'TESTIMONIAL', req.params.id as string, null, null);
...
export const bulkRemove = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    await AuditLogger.log(req, 'BULK_DELETE', 'TESTIMONIAL', null, null, { ids: req.body.ids });
