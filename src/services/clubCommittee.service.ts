import { ClubCommitteeRepository } from '../repositories/clubCommittee.repository';

export class ClubCommitteeService {
  private repository = new ClubCommitteeRepository();
