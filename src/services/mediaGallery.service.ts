import { MediaGalleryRepository } from '../repositories/mediaGallery.repository';

export class MediaGalleryService {
  private repository: MediaGalleryRepository;

  constructor() {
    this.repository = new MediaGalleryRepository();
  }
  ...
  async getById(id: string) {
    ...
    if (!item) throw new Error('MediaGallery not found');
    return item;
  }
