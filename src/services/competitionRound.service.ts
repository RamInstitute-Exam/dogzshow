import { CompetitionRoundRepository } from '../repositories/competitionRound.repository';

export class CompetitionRoundService {
  private repository: CompetitionRoundRepository;

  constructor() {
    this.repository = new CompetitionRoundRepository();
  }
  ...
  async getById(id: string) {
    ...
    if (!item) throw new Error('CompetitionRound not found');
    return item;
  }
