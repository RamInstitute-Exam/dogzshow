import { AgeClassRepository } from '../repositories/ageClass.repository';

export class AgeClassService {
  private repository: AgeClassRepository;

  constructor() {
    this.repository = new AgeClassRepository();
  }
  ...
  async getById(id: string) {
    ...
    if (!item) throw new Error('AgeClass not found');
    return item;
  }
