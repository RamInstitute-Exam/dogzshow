import { CompetitionMatchRepository } from '../repositories/competitionMatch.repository';

export class CompetitionMatchService {
  private repository: CompetitionMatchRepository;

  constructor() {
    this.repository = new CompetitionMatchRepository();
  }
  ...
  async getById(id: string) {
    ...
    if (!item) throw new Error('CompetitionMatch not found');
    return item;
  }
