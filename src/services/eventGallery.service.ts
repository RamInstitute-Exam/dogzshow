import { EventGalleryRepository } from '../repositories/eventGallery.repository';

export class EventGalleryService {
  private repository: EventGalleryRepository;

  constructor() {
    this.repository = new EventGalleryRepository();
  }
  ...
  async getById(id: string) {
    ...
    if (!item) throw new Error('EventGallery not found');
    return item;
  }
