...
const service = new sponsor_service_1.SponsorService();
...
const create = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield audit_logger_1.AuditLogger.log(req, 'CREATE', 'SPONSOR', data.id, null, data);
...
const update = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        cache_1.memoryCache.clear();
        yield audit_logger_1.AuditLogger.log(req, 'UPDATE', 'SPONSOR', data.id, null, data);
...
const remove = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        cache_1.memoryCache.clear();
        yield audit_logger_1.AuditLogger.log(req, 'DELETE', 'SPONSOR', req.params.id, null, null);
...
const bulkRemove = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        cache_1.memoryCache.clear();
        yield audit_logger_1.AuditLogger.log(req, 'BULK_DELETE', 'SPONSOR', null, null, { ids: req.body.ids });
