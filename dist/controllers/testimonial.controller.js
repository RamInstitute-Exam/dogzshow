...
const create = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield audit_logger_1.AuditLogger.log(req, 'CREATE', 'TESTIMONIAL', data.id, null, data);
...
const update = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield audit_logger_1.AuditLogger.log(req, 'UPDATE', 'TESTIMONIAL', data.id, null, data);
...
const remove = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield audit_logger_1.AuditLogger.log(req, 'DELETE', 'TESTIMONIAL', req.params.id, null, null);
...
const bulkRemove = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield audit_logger_1.AuditLogger.log(req, 'BULK_DELETE', 'TESTIMONIAL', null, null, { ids: req.body.ids });
