...
const create = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield audit_logger_1.AuditLogger.log(req, 'CREATE', 'EVENT', data.id, null, data);
...
const update = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield audit_logger_1.AuditLogger.log(req, 'UPDATE', 'EVENT', data.id, null, data);
...
const remove = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield audit_logger_1.AuditLogger.log(req, 'DELETE', 'EVENT', req.params.id, null, null);
...
const bulkRemove = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield audit_logger_1.AuditLogger.log(req, 'BULK_DELETE', 'EVENT', null, null, { ids: req.body.ids });
