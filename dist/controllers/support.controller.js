...
const service = new support_service_1.SupportService();
const getAll = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const result = yield service.getAll(req.query);
        res.status(200).json(Object.assign({ success: true, message: 'Support tickets retrieved successfully' }, result));
    }
    catch (error) {
...
const create = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
        const userId = ((_a = req.user) === null || _a === void 0 ? void 0 : _a.id) || req.body.userId || null;
        const ticketData = Object.assign(Object.assign({}, req.body), { userId });
        const data = yield service.create(ticketData);
