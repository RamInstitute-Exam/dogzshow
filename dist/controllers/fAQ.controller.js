...
const service = new fAQ_service_1.FAQService();
...
const create = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield audit_logger_1.AuditLogger.log(req, 'CREATE', 'FAQ', data.id, null, data);
...
const update = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield audit_logger_1.AuditLogger.log(req, 'UPDATE', 'FAQ', data.id, null, data);
...
const remove = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield audit_logger_1.AuditLogger.log(req, 'DELETE', 'FAQ', req.params.id, null, null);
...
const bulkRemove = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield audit_logger_1.AuditLogger.log(req, 'BULK_DELETE', 'FAQ', null, null, { ids: req.body.ids });
