...
const service = new owner_service_1.OwnerService();
const getAll = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const result = yield service.getAll(req.query);
        res.status(200).json(Object.assign({ success: true, message: 'Owners retrieved successfully' }, result));
    }
    catch (error) {
...
const create = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield audit_logger_1.AuditLogger.log(req, 'CREATE', 'OWNER', data.id, null, data);
...
const update = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield audit_logger_1.AuditLogger.log(req, 'UPDATE', 'OWNER', data.id, null, data);
...
const remove = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield audit_logger_1.AuditLogger.log(req, 'DELETE', 'OWNER', req.params.id, null, null);
...
const bulkRemove = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield audit_logger_1.AuditLogger.log(req, 'BULK_DELETE', 'OWNER', null, null, { ids: req.body.ids });
