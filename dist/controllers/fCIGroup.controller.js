...
const fCIGroup_service_1 = require("../services/fCIGroup.service");
const cache_1 = require("../utils/cache");
const service = new fCIGroup_service_1.FCIGroupService();
const getAll = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        res.setHeader('Cache-Control', 'public, max-age=86400, stale-while-revalidate=3600');
        const cacheKey = `fcigroup:all:${JSON.stringify(req.query)}`;
...
const create = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield audit_logger_1.AuditLogger.log(req, 'CREATE', 'FCIGROUP', data.id, null, data);
...
const update = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        cache_1.memoryCache.clear();
        yield audit_logger_1.AuditLogger.log(req, 'UPDATE', 'FCIGROUP', data.id, null, data);
...
const remove = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        cache_1.memoryCache.clear();
        yield audit_logger_1.AuditLogger.log(req, 'DELETE', 'FCIGROUP', req.params.id, null, null);
...
const bulkRemove = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        cache_1.memoryCache.clear();
        yield audit_logger_1.AuditLogger.log(req, 'BULK_DELETE', 'FCIGROUP', null, null, { ids: req.body.ids });
