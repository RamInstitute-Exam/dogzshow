...
class PermissionRepository {
    ...
    count(where) {
        return __awaiter(this, void 0, void 0, function* () {
            const finalWhere = Object.assign({ deletedAt: null }, where);
            return prisma_1.default.permission.count({ where: finalWhere });
        });
    }
    findById(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return prisma_1.default.permission.findFirst({
    ...
    delete(id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                return yield prisma_1.default.permission.update({
                    where: { id },
    ...
    bulkDelete(ids) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield prisma_1.default.permission.updateMany({
                    where: { id: { in: ids } },
                    data: { deletedAt: new Date() }
                });
            }
            catch (e) {
                return prisma_1.default.permission.deleteMany({
                    where: { id: { in: ids } }
                });
            }
        });
