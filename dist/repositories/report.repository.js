...
class ReportRepository {
    ...
    count(where) {
        return __awaiter(this, void 0, void 0, function* () {
            return prisma_1.default.report.count({ where });
        });
    }
    findById(id) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    update(id, data) {
        return __awaiter(this, void 0, void 0, function* () {
            return prisma_1.default.report.update({ where: { id }, data });
        });
    }
    delete(id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                return yield prisma_1.default.report.update({
                    where: { id },
    ...
    bulkDelete(ids) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield prisma_1.default.report.updateMany({
                    where: { id: { in: ids } },
                    data: { deletedAt: new Date() }
                });
            }
