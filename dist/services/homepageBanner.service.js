...
exports.HomepageBannerService = void 0;
const homepageBanner_repository_1 = require("../repositories/homepageBanner.repository");
class HomepageBannerService {
    constructor() {
        this.repository = new homepageBanner_repository_1.HomepageBannerRepository();
    }
    getAll(query) {
            ...
            try {
                ...
                if (count === 0) {
                    yield this.repository.create({
                        title: 'Welcome to JuzDog Championship',
                        desktopImage: '/images/hero_banner.png',
                        mobileImage: '/images/hero_banner.png',
                        redirectUrl: '/events',
                        status: 'ACTIVE',
                        targetBlank: false,
                        sortOrder: 1
                ...
                console.error('Failed to auto-seed homepage banners:', e);
            }
    ...
    getById(id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!item)
                throw new Error('HomepageBanner not found');
            return item;
        });
    }
    create(data) {
...
exports.HomepageBannerService = HomepageBannerService;
