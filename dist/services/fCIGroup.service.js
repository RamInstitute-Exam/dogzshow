...
exports.FCIGroupService = void 0;
const fCIGroup_repository_1 = require("../repositories/fCIGroup.repository");
class FCIGroupService {
    constructor() {
        this.repository = new fCIGroup_repository_1.FCIGroupRepository();
    }
    getAll(query) {
    ...
    getById(id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!item)
                throw new Error('FCIGroup not found');
            return item;
        });
    }
    create(data) {
...
exports.FCIGroupService = FCIGroupService;
