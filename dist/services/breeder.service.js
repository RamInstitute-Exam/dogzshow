...
const breeder_repository_1 = require("../repositories/breeder.repository");
class BreederService {
    constructor() {
        this.repository = new breeder_repository_1.BreederRepository();
    }
    getAll(query) {
...
exports.BreederService = BreederService;
