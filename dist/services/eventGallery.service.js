...
exports.EventGalleryService = void 0;
const eventGallery_repository_1 = require("../repositories/eventGallery.repository");
class EventGalleryService {
    constructor() {
        this.repository = new eventGallery_repository_1.EventGalleryRepository();
    }
    getAll(query) {
    ...
    getById(id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!item)
                throw new Error('EventGallery not found');
            return item;
        });
    }
    create(data) {
...
exports.EventGalleryService = EventGalleryService;
