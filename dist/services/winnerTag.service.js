...
exports.WinnerTagService = void 0;
const winnerTag_repository_1 = require("../repositories/winnerTag.repository");
class WinnerTagService {
    constructor() {
        this.repository = new winnerTag_repository_1.WinnerTagRepository();
    }
    getAll(query) {
    ...
    getById(id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!item)
                throw new Error('WinnerTag not found');
            return item;
        });
    }
    create(data) {
...
exports.WinnerTagService = WinnerTagService;
