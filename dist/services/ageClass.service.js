...
exports.AgeClassService = void 0;
const ageClass_repository_1 = require("../repositories/ageClass.repository");
class AgeClassService {
    constructor() {
        this.repository = new ageClass_repository_1.AgeClassRepository();
    }
    getAll(query) {
    ...
    getById(id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!item)
                throw new Error('AgeClass not found');
            return item;
        });
    }
    create(data) {
...
exports.AgeClassService = AgeClassService;
