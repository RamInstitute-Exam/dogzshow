...
exports.CompetitionRoundService = void 0;
const competitionRound_repository_1 = require("../repositories/competitionRound.repository");
class CompetitionRoundService {
    constructor() {
        this.repository = new competitionRound_repository_1.CompetitionRoundRepository();
    }
    getAll(query) {
    ...
    getById(id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!item)
                throw new Error('CompetitionRound not found');
            return item;
        });
    }
    create(data) {
...
exports.CompetitionRoundService = CompetitionRoundService;
