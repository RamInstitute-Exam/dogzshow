...
const notificationTemplate_repository_1 = require("../repositories/notificationTemplate.repository");
class NotificationTemplateService {
    constructor() {
        this.repository = new notificationTemplate_repository_1.NotificationTemplateRepository();
    }
    getAll(query) {
