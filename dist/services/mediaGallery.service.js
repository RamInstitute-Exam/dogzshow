...
const mediaGallery_repository_1 = require("../repositories/mediaGallery.repository");
class MediaGalleryService {
    constructor() {
        this.repository = new mediaGallery_repository_1.MediaGalleryRepository();
    }
    getAll(query) {
    ...
    getById(id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!item)
                throw new Error('MediaGallery not found');
            return item;
        });
    }
    create(data) {
