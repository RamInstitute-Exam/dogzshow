...
exports.CompetitionMatchService = void 0;
const competitionMatch_repository_1 = require("../repositories/competitionMatch.repository");
class CompetitionMatchService {
    constructor() {
        this.repository = new competitionMatch_repository_1.CompetitionMatchRepository();
    }
    getAll(query) {
    ...
    getById(id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!item)
                throw new Error('CompetitionMatch not found');
            return item;
        });
    }
    create(data) {
...
exports.CompetitionMatchService = CompetitionMatchService;
