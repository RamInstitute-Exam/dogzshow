...
exports.EventCategoryService = void 0;
const eventCategory_repository_1 = require("../repositories/eventCategory.repository");
class EventCategoryService {
    constructor() {
        this.repository = new eventCategory_repository_1.EventCategoryRepository();
    }
    getAll(query) {
